...
module.exports = {
  ...
  async execute(message, args) {
    ...
    message.channel.send("🔁 ${member.user.tag} a été soft-ban par ${message.author.tag}");
    logToChannel(message, `🔁 ${member.user.tag} a été soft-ban par ${message.author.tag}`);
