...
module.exports = {
  name: 'ticketban',
  description: 'Commande ticketban',
  async execute(message, args) {
    ...
    message.channel.send("🚫 ${member.user.tag} a été banni des tickets par ${message.author.tag}");
    logToChannel(message, `🚫 ${member.user.tag} a été banni des tickets par ${message.author.tag}`);
