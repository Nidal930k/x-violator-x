...
module.exports = {
  name: 'reportban',
  description: 'Commande reportban',
  async execute(message, args) {
    ...
    message.channel.send("🚨 ${member.user.tag} a été report et banni par ${message.author.tag}");
    logToChannel(message, `🚨 ${member.user.tag} a été report et banni par ${message.author.tag}`);
